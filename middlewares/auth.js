...
exports.authWeixin = function (req, res, next) {
  ...
  var redirectBaseUrl = authorizeUrl + '?appid=' + appid + '&redirect_uri=' + encodeURIComponent(req.originalUrl) + '&response_type=code&scope=snsapi_base&state=0#wechat_redirect';
